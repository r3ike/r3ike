...
# 💻 Tech Stack:
## Backend Stack:
[![My Skills](https://skillicons.dev/icons?i=js,nodejs,express,mysql,postgres,mongodb,docker,kubernetes,linux,nginx)](https://skillicons.dev)


## Software's dev Stack:
[![My Skills](https://skillicons.dev/icons?i=c,cpp,cmake,dart,flutter,java,php)](https://skillicons.dev)

## Others
[![My Skills](https://skillicons.dev/icons?i=ros,git,github,githubactions,bash,cloudflare,latex,ubuntu)](https://skillicons.dev)
